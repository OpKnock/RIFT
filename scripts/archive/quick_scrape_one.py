"""Quick scrape: S1, midterm_1 only."""
...
def main():
    ...
    csv_path = path / "wearable_exam_stress_S1_midterm1.csv"
    ...
    sidecar.write_text(json.dumps({
        ...
        "subjects": ["S1"],
        "recordings": all_prov,
        "note": "Mean per modality for midterm_1 only. Subject identity preserved. No clinical outcomes.",
    }, indent=2))
