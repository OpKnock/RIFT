...
- Healthcare demo: `health/` (PatientState/EHR/wearable sources/baseline/transition/risk/twin/FORESIGHT/robustness/Guardian/explain/evaluate/demo data); engine stays generic in `src/rift/`
